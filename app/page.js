    ...
    <>
      ...
      <div className="bg-neutral-900   flex flex-col items-center p-8 ">
        ...
        <div className=" font-normal tracking-wide text-neutral-400 leading-normal  flex flex-col items-center justify-center ">
          <h1 className="text-lg font-medium mb-2 text-neutral-300">Ready to Start Building Wealth Today?</h1>
          ...
          <button className="w-fit bg-primary text-neutral-800 px-4 py-2 text-base rounded-xl font-medium">Quick Browse</button>
        </div>
