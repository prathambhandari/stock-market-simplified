...
export default function MVP() {
    return (
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-4 *:rounded-2xl">
                ...
                <div className="z-20 relative">
                    <div className=" flex flex-col items-start justify-start  ">
                        <div className="flex flex-col items-start  justify-center mb-2">
                            ...
                            <h1 className="text-2xl font-semibold  text-neutral-600 dark:text-lime-300 tracking-wide leading-normal">Unlock the Full Course for Only ₹499 – Save Over 80% Compared to Other Platforms!</h1>
                        </div>
            ...
            <div className="h-full col-span-1 bg-neutral-50 dark:bg-neutral-900 flex flex-col items-start justify-start p-8 rounded-2xl font-mono relative drop-shadow-sm hover:drop-shadow cursor-pointer">
                <RiGroup3Fill className=" h-28 w-28  text-neutral-500 mb-4 " />
                <h1 className="text-2xl font-semibold  text-neutral-600 dark:text-lime-300 tracking-wide mb-2">What Makes Us Different?</h1>
                ...
                <button className="bg-lime-300 text-neutral-950 rounded-lg px-3 py-2 text-lg font-medium tracking-wide">Start My Journey Now!</button>
