            ...
            <div className="z-20 relative">
                <div className=" flex flex-col items-start justify-start  ">
                    <div className="flex flex-row items-center  justify-center mb-4">
                        <RiUserStarLine className=" h-6 w-6 text-neutral-900   " />
                        <h1 className="text-md font-semibold text-neutral-900  tracking-wide ps-4 leading-normal">Pratham Bhandari</h1>
                    </div>
                    <div className="text-base font-normal  text-neutral-900   tracking-wide leading-loose">
                        ...
                        <span className="font-semibold text-base mt-2">- Founder, prathambhandari.com</span>
